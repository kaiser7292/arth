...
function styles(): string {
  return `
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page-header-fixed .phf-account { font-size: 12px; font-weight: 600; }
    ...
    /* Footer (page-1 inline footer) */
    .footer { margin-top: 24px; text-align: center; font-size: 9px; color: #94A3B8; border-top: 1px solid #E2E8F0; padding-top: 12px; padding-bottom: 8px; }
  `;
}
...
<div class="page-footer-fixed">
  Generated by <strong>Arth</strong> · ${today} · All data is private and stored only on your device.
</div>
<div class="container">
