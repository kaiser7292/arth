---
title: Getting started with Arth
slug: getting-started
summary: What Arth does, how the five tabs are organized, and what to do in your first week.
tags: [basics, setup, onboarding, tour, tabs, home, review, navigation]
contextKeys: [home, onboarding]
phrasings:
  - How do I start using Arth?
  - What can Arth do?
  - I just installed Arth, now what?
  - Quick tour of the app
  - Where do I find everything?
  - Is this app free?
  - Does Arth upload my data?
  - What are the tabs for?
  - First week with Arth
  - Home tab explained
...
Arth is a private finance tracker that runs entirely on your phone. No account, no cloud, no sign-up. You can use it offline forever.

## The three things to know

1. **Expenses arrive two ways.** Arth reads your bank SMS automatically, or you tap the **+** button and log one yourself.
...
**iPhone / iPad?** Auto-SMS on iOS is restricted by the OS, so you'd log manually. The rest of Arth works the same.
...
- [Teach Arth a new bank - Smart SMS Templates](smart-sms-templates)
