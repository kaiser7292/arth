...
export function Toggle({
  ...
  return (
    <View className="mb-3">
      ...
      <View className="flex-row rounded-lg border border-border-light dark:border-border-dark overflow-hidden">
        {options.map((opt) => (
          <Pressable
            key={opt.value}
  ...
  return (
    <View className="mb-3">
      ...
      <Pressable
        ...
        className="flex-row items-center justify-between rounded-lg border border-border-light dark:border-border-dark bg-white dark:bg-surface-dark-alt px-3 py-3"
      >
      ...
      {expanded && (
        <View className="mt-1 rounded-lg border border-border-light dark:border-border-dark bg-white dark:bg-surface-dark-alt max-h-48">
...
export function BreakdownRow({
  ...
  return (
    <View className="flex-row items-center justify-between py-1.5">
      ...
      {monthly !== undefined && (
        <Text className="text-xs text-text-tertiary text-right w-24">
