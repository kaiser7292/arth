        ...
        <Section title="Compare table" note="Real worst case: 7-digit amounts with paise, a 4-digit change, the longest category name.">
          <Card>
            <View className="flex-row items-center pb-2 border-b border-border mb-1">
              ...
              <Text className="w-[84px] ml-1.5 text-xs font-semibold text-faint-foreground text-right">R1</Text>
              <Text className="w-[84px] ml-1.5 text-xs font-semibold text-faint-foreground text-right">R2</Text>
              <Text className="w-14 ml-1.5 text-xs font-semibold text-faint-foreground text-right">Chg</Text>
            </View>
            {[["Rent & Utilities", "₹12,34,567.89", "₹20,772.35", "+2881%"],
              ...
              <View key={r[0]} className="flex-row items-center py-2 border-b border-border">
                ...
                <Text className="w-[84px] ml-1.5 text-label text-right" style={{ color: theme.primary }} numberOfLines={1}>{r[1]}</Text>
                <Text className="w-[84px] ml-1.5 text-label font-medium text-right" style={{ color: theme.primary }} numberOfLines={1}>{r[2]}</Text>
                <Text className="w-14 ml-1.5 text-label font-bold text-right" style={{ color: theme.danger }}>{r[3]}</Text>
              </View>
            ))}
          </Card>
        </Section>
