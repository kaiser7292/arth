...
import migration058 from "./058_reconciliation_sessions";
import migration059 from "./059_reconciliation_items";
import migration060 from "./060_reconciliation_pre_arth_cutoff";
import migration061 from "./061_applied_rule_ids";
import migration062 from "./062_smart_rules_pending_retroactive";
import migration063 from "./063_insurance_policies";
import migration064 from "./064_add_closed_at_accounts";
import migration065 from "./065_recurring_relative_frequencies";
import migration066 from "./066_applied_rule_manually";
import migration067 from "./067_smart_rule_applies_to";
import migration068 from "./068_expense_composite_index";
import migration069 from "./069_repair_unguarded_columns";
import migration070 from "./070_repair_reminder_fulfillments_fk";
import migration071 from "./071_simulator_recurring_entries";
import migration072 from "./072_investment_accounts";
